...
| **Zaliczaj tylko to, co uderzone** | Zapis osobny dla każdego trybu. Domyślnie włączone w Interwałach, wyłączone w Skalach, Arpeggiach i Formułach. Po włączeniu również CQT wymaga potwierdzonego ataku po początku rundy w tych czterech trybach. Interwały zachowują wyjątek dla potwierdzonego uderzenia akordu. Wyłącz dla legato lub modelu bez głowicy ataków |
