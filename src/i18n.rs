...
pub const EN: Strings = Strings {
    ...
    single_notes_hint: "Off, a whole chord passes its intervals one after another. On, each note has to be played on its own and a repeated note needs a fresh attack.",
    shuffle_chords: "Shuffle the chords as well",
    shuffle_chords_hint: "Applies with the shuffle on. Off, it only reorders the tones and the progression stays as written - which is what makes a tune out of it. On, the chords are drawn at random too.",
    ...
    pattern: "Pattern:",
    key_root: "Key:",
    random_hint: "In the note modes it shuffles the tones inside each chord; the progression itself follows the switch below.",
...
pub const PL: Strings = Strings {
    ...
    single_notes_hint: "Wyłączone - cały akord zalicza swoje interwały po kolei. Włączone - każdy dźwięk trzeba zagrać osobno, a powtórzony wymaga nowego szarpnięcia.",
    shuffle_chords: "Losuj także kolejność akordów",
    shuffle_chords_hint: "Działa przy włączonym losowaniu. Wyłączone - losowana jest tylko kolejność dźwięków, a progresja zostaje taka, jak zapisana, i to z niej robi się melodia. Włączone - akordy też lecą losowo.",
    ...
    pattern: "Wzorzec:",
    key_root: "Tonacja:",
    random_hint: "W trybach dźwiękowych miesza składniki akordu; sama progresja idzie za przełącznikiem poniżej.",
