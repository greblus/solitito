...
pub const EN: Strings = Strings {
    ...
    preview: "View",
    preview_hint: "The line of intervals says which degrees; the drawings say where the fingers go. On the neck a phrase is drawn in the position it is played, with the note due ringed - which keeps a long study readable. An interval set is a grip either way, and the fretboard trainer its region.",
...
pub const PL: Strings = Strings {
    ...
    preview: "Widok",
    preview_hint: "Linia interwałów mówi, które stopnie; rysunki mówią, gdzie idą palce. Na podstrunnicy fraza rysowana jest w pozycji, w której się ją gra, z pierścieniem na dźwięku, który jest na kolei — dzięki temu długie studium pozostaje czytelne. Zbiór interwałów jest chwytem w obu widokach, a Gryf pokazuje swój region.",
