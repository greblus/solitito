...
pub const EN: Strings = Strings {
    ...
    shuffle_chords_hint: "Applies with the shuffle on. Off, the progression stays as written, which is what turns it into a tune. On, the chords are drawn at random too.",
...
pub const PL: Strings = Strings {
    ...
    shuffle_chords_hint: "Działa przy włączonym losowaniu. Wyłączone - progresja zostaje taka, jak zapisana, i to z niej robi się melodia. Włączone - akordy też lecą losowo.",
