...
Skala przy tym po każdym przejściu się przesuwa, niezależnie od tego przełącznika: obchodzi
trzy struny, od których warto ją zaczynać, i za każdym razem zawraca — raz w górę, raz w dół.
Liczona, a nie losowana: trzy struny i dwa kierunki są względnie pierwsze, więc sześć przejść
pokrywa wszystkie sześć sposobów, podczas gdy uczciwa moneta potrafiła dać pięć zejść z rzędu
i czytało się to jak zepsute ćwiczenie. Przycisk
...
### Wyświetlanie kształtów na podstrunnicy i tabulatur to pomoc na na początku
